...
- delegate to the story-converter agent anywhere except a scope amendment, a story amendment, step 16's completion sync, or step 0's register-mode call for a standalone run - no routine or scheduled ticket updates
