...
export function formatStoryBacklogJson(backlog) {
    if (!backlog.meta) {
...
export function formatDecisionLogJsonl(decisions) {
...
async function main() {
    ...
    try {
        ...
        execFileSync("git", ["-C", worktreeDir, "add", ".claude/state/story-backlog.json", ".claude/state/decision-log.jsonl"], { stdio: "inherit" });
